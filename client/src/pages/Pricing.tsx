...
const Pricing = () => {
  ...
  const handlePurchase = async (planId: string) => {
    try {
      ...
      const { data } = await api.post('/api/user/purchase-credites', { planId })
    ...
    <>
      <div className="w-full max-w-5xl mx-auto z-20 max-md:px-4 min-h-[80vh]">
        <div className="text-center mt-16">
          <h2 className="text-gray-100 text-3xl font-medium">Chose your plan</h2>
        ...
        {/* some description */}
        <p className="mx-auto text-center text-sm max-w-md mt-10 text-white/60 font-light">Project <span className="text-white">Creation/Revision</span>Consume <span className="text-white">5 credits</span>.You can purchase more credits more projects.</p>
