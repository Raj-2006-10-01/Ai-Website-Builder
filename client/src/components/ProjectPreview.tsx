...
const ProjectPreview = forwardRef<ProjectPreviewRef, ProjectPreviewProps>(
    (
        ...
        return (
            <div className='relative h-full w-full bg-gray-900 flex rounded-xl overflow-auto'>
                {project.current_code ? (
                    <>
                        ...
                        />
                        {showEditerPanel && selectedElement && (
                            <EditerPanel selectedElement={selectedElement}
